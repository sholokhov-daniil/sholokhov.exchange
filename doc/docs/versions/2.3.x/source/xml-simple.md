...
При инициализации объекта в конструктор мы обязаны указать способ `Reader`.   
В качестве `Reader` может выступать любой реализующий интерфейс [DataReaderInterface](/2.3.x/reader/).  
...
$reader = new LocalFileReader('https:\\my-web.com');
